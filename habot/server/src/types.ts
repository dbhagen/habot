...
export type ClientMessage =
  | { type: "send_message"; sessionId: string; content: string; images?: ImageAttachment[] }
  | { type: "cancel"; sessionId: string }
  | { type: "approve_tool"; sessionId: string; toolUseId: string; approved: boolean; autoApprove?: boolean; denyMessage?: string }
  | { type: "list_sessions" }
